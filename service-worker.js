...
function md5(string) {
    ...
    function convertToWordArray(string) {
        ...
        const lNumberOfWords_temp1 = (lMessageLength + 8) >> 6;
        const lNumberOfWords_temp2 = (lNumberOfWords_temp1 + 1) * 16;
        const lWordArray = Array(lNumberOfWords_temp2 - 1);
        let lBytePosition = 0;
        let lByteCount = 0;
        ...
        lWordArray[lNumberOfWords_temp2 - 2] = lMessageLength << 3;
        lWordArray[lNumberOfWords_temp2 - 1] = lMessageLength >>> 29;
        return lWordArray;
    }
...
async function translateText(text) {
    try {
        ...
        // 生成签名字符串
        const rawStr = BAIDU_APP_ID + text + salt + BAIDU_KEY;
        console.log('Raw string for sign:', rawStr);
